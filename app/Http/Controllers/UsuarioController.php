...
use App\User;
use App\Role;
use App\Http\Requests\FormUsuarioUpdateRequest;
use App\Http\Requests\FormCrearUsuarioRequest;
...
{   
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(FormCrearUsuarioRequest $request)
    {
        ...
        return redirect()->route('usuarios.index')->with('success', 'se ha registrado un nuevo usuario');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(FormUsuarioUpdateRequest $request, $id)
    {   
        ...
        return back()->with('info', 'se ha actualizado al usuario correctamente');
    }
    ...
    public function destroy($id)
    {
        ...
        return back()->with('destroy', 'se ha eliminado al usuario');
    }
}
