...
{   
    ...
    public function store(Request $request)
    {
        if (auth()->check()) {
            ...
            return redirect()->route('mensajes.index')->with('success', 'Se ha enviado su mensaje correctamente');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with('info', 'se ha actualizado su mensaje correctamente');
    }
    ...
    public function destroy($id)
    {
        ...
        return back()->with('destroy', 'se ha eliminado el mensaje correctamente');
    }
}
