...
{	
    ...
    {	
	    ...
	    return back()->with('iniciado', 'se ha iniciado la orden de servicio correctamente ahora se encuentra en proceso.');
    }
    ...
    {	
    	...
    	if ($orden->trabajador_id == auth()->user()->trabajador->id) 
    	{
		    ...
		    return back()->with('finalizado', 'se ha finalizado la orden de servicio con exito.');
    	}
