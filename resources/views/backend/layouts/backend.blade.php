...
<head>
  ...
  <title>Basic Tables - Stack Responsive Bootstrap 4 Admin Template</title>
...
data-menu="horizontal-menu" data-col="2-columns">
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="{{ route('dashboard') }}">
              ...
              <h2 class="brand-text">ORDER SERVICES V1.0</h2>
            </a>
          </li>
      ...
      <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        @if (auth()->check())
          ...
          @if (Auth::user()->hasRoles(['admin']))
            ...
            <li class="nav-item"><a class="nav-link" href="{{ route('trabajadores') }}" ><i class="ft-users"></i><span>Trabajadores</span></a>
            </li>
          @endif

          <li class="nav-item"><a class="nav-link" href="{{ route('pagina.ordenes_de_servicios') }}" ><i class="ft-clipboard"></i><span>Ordenes de Trabajo</span></a>
          </li>
  ...
  <footer class="footer footer-static footer-light navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      ...
      <span class="float-md-right d-block d-md-inline-block d-none d-lg-block">Made with <i class="ft-heart pink"></i></span>
    </p>
  </footer>
